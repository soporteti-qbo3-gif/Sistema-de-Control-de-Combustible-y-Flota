...
export interface Vehiculo {
  ...
  rendimientoTeoricoKmL: number; // km/L esperado de fábrica
  ubicacion?: string;
...
export interface MovimientoSaldo {
  ...
  saldoId: string;
  estacionNombre: string;
  tipoCombustible?: string; // Obtenido de la factura para bitácora en descuentos
